...
public final class AutomationPairingTrait {
    ...
    public static final PropertyKey<Integer> STAT_COUNT =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "c", java.lang.Integer.class);
    ...
    public static final PropertyKey<Integer> STAT_LAST =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "last", java.lang.Integer.class);
    ...
    public static final PropertyKey<URI> CONF_SOURCE =
            new PropertyKey<>(Section.CONFIG, TRAIT_ID, "src", URI.class);
    ...
    public static final PropertyKey<URI> CONF_DESTINATION =
            new PropertyKey<>(Section.CONFIG, TRAIT_ID, "dst", URI.class);
    ...
    public static final PropertyKey<Boolean> CONF_PUSH =
            new PropertyKey<>(
                    Section.CONFIG, TRAIT_ID, "push", java.lang.Boolean.class);
    ...
    public static final PropertyKey<Boolean> CONF_PULL =
            new PropertyKey<>(
                    Section.CONFIG, TRAIT_ID, "pull", java.lang.Boolean.class);
    ...
    public static final PropertyKey<String> CONF_FORWARD_TRANSFORM =
            new PropertyKey<>(Section.CONFIG, TRAIT_ID, "xfwd", java.lang.String.class);
    ...
    public static final PropertyKey<String> CONF_REVERSE_TRANSFORM =
            new PropertyKey<>(Section.CONFIG, TRAIT_ID, "xrev", java.lang.String.class);
