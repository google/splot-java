...
public final class OnOffTrait {
    ...
    public static final PropertyKey<Float> CONF_DURATION_OFF =
            new PropertyKey<>(PropertyKey.SECTION_CONFIG, TRAIT_ID, "doff", java.lang.Float.class);
    ...
    public static final PropertyKey<Float> CONF_DURATION_ON =
            new PropertyKey<>(PropertyKey.SECTION_CONFIG, TRAIT_ID, "don", java.lang.Float.class);
    ...
    public static final PropertyKey<String> CONF_SCENE_ID_ON =
            new PropertyKey<>(PropertyKey.SECTION_CONFIG, TRAIT_ID, "scon", java.lang.String.class);
    ...
    public static final PropertyKey<Boolean> CONF_IS_LIGHT =
            new PropertyKey<>(
                    PropertyKey.SECTION_CONFIG, TRAIT_ID, "islt", java.lang.Boolean.class);
}
