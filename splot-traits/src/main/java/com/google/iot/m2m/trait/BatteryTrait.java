...
public final class BatteryTrait {
    ...
    public static final PropertyKey<Float> STAT_CHARGE_REMAINING =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "vpct", java.lang.Float.class);
    ...
    public static final PropertyKey<Integer> STAT_ENERGY_REMAINING =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "vnrg", java.lang.Integer.class);
    ...
    public static final PropertyKey<Boolean> STAT_NEEDS_SERVICE =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "sreq", java.lang.Boolean.class);
    ...
    public static final PropertyKey<String> STAT_CHARGE_STATE =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "stat", java.lang.String.class);
    ...
    public static final PropertyKey<Float> STAT_CAPACITY_REMAINING =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "rcap", java.lang.Float.class);
    ...
    public static final PropertyKey<Integer> STAT_CHARGE_CYCLES =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "cycl", java.lang.Integer.class);
    ...
    public static final PropertyKey<float[]> STAT_CELL_VOLTAGE =
            new PropertyKey<>(Section.STATE, TRAIT_ID, "celV", float[].class);
