...
public abstract class DiscoveryBuilder {
    /**
     * Determines if functional endpoints that are hosted by this {@link Technology} should be
     ...
     *
     * @param includeHosted true if hosted functional endpoint should be included in discovery
     ...
     * discovered functional endpoints, including groups. If the technology does not support groups,
    ...
    /**
     * Determines the maximum amount of time that should be spent discovering functional endpoints.
    ...
    /**
     * Indicates that this discovery operation is to be limited to returning functional endpoints
     ...
     * endpoints.
     *
     * @param traitShortName the trait short name to match on discovered functional endpoints.
     * @return a convenience reference to this discovery builder object.
     */
     ...
     *
     * <p>If this criteria is specified, there is generally only a single {@link FunctionalEndpoint}
     * (or no functional endpoints) returned. However, more may be returned if there is a UID
     * conflict.
     *
     * @param uid the uid string to match for discovered functional endpoints.
     * @return a convenience reference to this discovery builder object.
    ...
    /**
     * Determines the maximum number of functional endpoints which can be discovered before the
     ...
     *
     * @param count The maximum number of functional endpoints to discover, or zero if there is no
     *     maximum.
     * @return a convenience reference to this discovery builder object.
     */
